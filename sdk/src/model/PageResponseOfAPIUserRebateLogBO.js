...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/APIUserRebateLogBO'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./APIUserRebateLogBO'));
  } else {
    // Browser globals (root is window)
    if (!root.Api) {
      root.Api = {};
    }
    root.Api.PageResponseOfAPIUserRebateLogBO = factory(root.Api.ApiClient, root.Api.APIUserRebateLogBO);
  }
}(this, function(ApiClient, APIUserRebateLogBO) {
  'use strict';
  ...
  /**
   * The PageResponseOfAPIUserRebateLogBO model module.
   * @module model/PageResponseOfAPIUserRebateLogBO
   * @version 1.0
   */

  /**
   * Constructs a new <code>PageResponseOfAPIUserRebateLogBO</code>.
   * @alias module:model/PageResponseOfAPIUserRebateLogBO
   * @class
   */
  ...
  /**
   * Constructs a <code>PageResponseOfAPIUserRebateLogBO</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageResponseOfAPIUserRebateLogBO} obj Optional instance to populate.
   * @return {module:model/PageResponseOfAPIUserRebateLogBO} The populated <code>PageResponseOfAPIUserRebateLogBO</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [APIUserRebateLogBO]);
      }
  ...
  /**
   * @member {Array.<module:model/APIUserRebateLogBO>} content
   */
