...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Api.PageResponseOfAPIUmMachineBO = factory(root.Api.ApiClient, root.Api.APIUmMachineBO);
  }
  ...
  /**
   * The PageResponseOfAPIUmMachineBO model module.
   * @module model/PageResponseOfAPIUmMachineBO
   * @version 1.0
   */

  /**
   * Constructs a new <code>PageResponseOfAPIUmMachineBO</code>.
   * @alias module:model/PageResponseOfAPIUmMachineBO
   * @class
   */
  ...
  /**
   * Constructs a <code>PageResponseOfAPIUmMachineBO</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageResponseOfAPIUmMachineBO} obj Optional instance to populate.
   * @return {module:model/PageResponseOfAPIUmMachineBO} The populated <code>PageResponseOfAPIUmMachineBO</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [APIUmMachineBO]);
      }
  ...
  /**
   * @member {Array.<module:model/APIUmMachineBO>} content
   */
