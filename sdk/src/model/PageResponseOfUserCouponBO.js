...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/UserCouponBO'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./UserCouponBO'));
  } else {
    // Browser globals (root is window)
    if (!root.Api) {
      root.Api = {};
    }
    root.Api.PageResponseOfUserCouponBO = factory(root.Api.ApiClient, root.Api.UserCouponBO);
  }
}(this, function(ApiClient, UserCouponBO) {
  'use strict';
  ...
  /**
   * The PageResponseOfUserCouponBO model module.
   * @module model/PageResponseOfUserCouponBO
   * @version 1.0
   */

  /**
   * Constructs a new <code>PageResponseOfUserCouponBO</code>.
   * @alias module:model/PageResponseOfUserCouponBO
   * @class
   */
  ...
  /**
   * Constructs a <code>PageResponseOfUserCouponBO</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageResponseOfUserCouponBO} obj Optional instance to populate.
   * @return {module:model/PageResponseOfUserCouponBO} The populated <code>PageResponseOfUserCouponBO</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [UserCouponBO]);
      }
  ...
  /**
   * @member {Array.<module:model/UserCouponBO>} content
   */
