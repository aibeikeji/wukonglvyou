...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/APIUmbrellaBO'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./APIUmbrellaBO'));
  } else {
    // Browser globals (root is window)
    if (!root.Api) {
      root.Api = {};
    }
    root.Api.PageResponseOfAPIUmbrellaBO = factory(root.Api.ApiClient, root.Api.APIUmbrellaBO);
  }
}(this, function(ApiClient, APIUmbrellaBO) {
  'use strict';
  ...
  /**
   * The PageResponseOfAPIUmbrellaBO model module.
   * @module model/PageResponseOfAPIUmbrellaBO
   * @version 1.0
   */

  /**
   * Constructs a new <code>PageResponseOfAPIUmbrellaBO</code>.
   * @alias module:model/PageResponseOfAPIUmbrellaBO
   * @class
   */
  ...
  /**
   * Constructs a <code>PageResponseOfAPIUmbrellaBO</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageResponseOfAPIUmbrellaBO} obj Optional instance to populate.
   * @return {module:model/PageResponseOfAPIUmbrellaBO} The populated <code>PageResponseOfAPIUmbrellaBO</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [APIUmbrellaBO]);
      }
  ...
  /**
   * @member {Array.<module:model/APIUmbrellaBO>} content
   */
