...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Api.PageResponseOfAPIUmOrderBO = factory(root.Api.ApiClient, root.Api.APIUmOrderBO);
  }
  ...
  /**
   * The PageResponseOfAPIUmOrderBO model module.
   * @module model/PageResponseOfAPIUmOrderBO
   * @version 1.0
   */

  /**
   * Constructs a new <code>PageResponseOfAPIUmOrderBO</code>.
   * @alias module:model/PageResponseOfAPIUmOrderBO
   * @class
   */
  ...
  /**
   * Constructs a <code>PageResponseOfAPIUmOrderBO</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageResponseOfAPIUmOrderBO} obj Optional instance to populate.
   * @return {module:model/PageResponseOfAPIUmOrderBO} The populated <code>PageResponseOfAPIUmOrderBO</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [APIUmOrderBO]);
      }
  ...
  /**
   * @member {Array.<module:model/APIUmOrderBO>} content
   */
