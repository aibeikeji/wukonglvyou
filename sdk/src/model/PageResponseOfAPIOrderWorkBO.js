...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Api.PageResponseOfAPIOrderWorkBO = factory(root.Api.ApiClient, root.Api.APIOrderWorkBO);
  }
  ...
  /**
   * The PageResponseOfAPIOrderWorkBO model module.
   * @module model/PageResponseOfAPIOrderWorkBO
   * @version 1.0
   */

  /**
   * Constructs a new <code>PageResponseOfAPIOrderWorkBO</code>.
   * @alias module:model/PageResponseOfAPIOrderWorkBO
   * @class
   */
  ...
  /**
   * Constructs a <code>PageResponseOfAPIOrderWorkBO</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageResponseOfAPIOrderWorkBO} obj Optional instance to populate.
   * @return {module:model/PageResponseOfAPIOrderWorkBO} The populated <code>PageResponseOfAPIOrderWorkBO</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [APIOrderWorkBO]);
      }
  ...
  /**
   * @member {Array.<module:model/APIOrderWorkBO>} content
   */
