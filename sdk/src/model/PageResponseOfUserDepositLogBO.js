...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/UserDepositLogBO'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./UserDepositLogBO'));
  } else {
    // Browser globals (root is window)
    if (!root.Api) {
      root.Api = {};
    }
    root.Api.PageResponseOfUserDepositLogBO = factory(root.Api.ApiClient, root.Api.UserDepositLogBO);
  }
}(this, function(ApiClient, UserDepositLogBO) {
  'use strict';
  ...
  /**
   * The PageResponseOfUserDepositLogBO model module.
   * @module model/PageResponseOfUserDepositLogBO
   * @version 1.0
   */

  /**
   * Constructs a new <code>PageResponseOfUserDepositLogBO</code>.
   * @alias module:model/PageResponseOfUserDepositLogBO
   * @class
   */
  ...
  /**
   * Constructs a <code>PageResponseOfUserDepositLogBO</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageResponseOfUserDepositLogBO} obj Optional instance to populate.
   * @return {module:model/PageResponseOfUserDepositLogBO} The populated <code>PageResponseOfUserDepositLogBO</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [UserDepositLogBO]);
      }
  ...
  /**
   * @member {Array.<module:model/UserDepositLogBO>} content
   */
